DoHeatmapICA=function(data="NULL",nics="IC_1",GeneStatICA="NULL",ngenes=10,ProjectName="Default"){
  ...
  pheatmap(data_heat,clustering_method = "ward.D",color=myColor, breaks=myBreaks,,clustering_distance_cols = "correlation",filename=paste0(DirIC,"/Heatmap_loadings_gene_All_IC_best,",ngenes,".pdf"),width = 15,height=30)
