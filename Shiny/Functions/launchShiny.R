launchShiny <- function(
  ...
  Shiny.options <<- list(
    ...
    "shiny_root" = "/home/c_thuilliez/Desktop/Work/script/Shiny/",
  ...
  ##--------------------------------------------------------------------------##
  source(
    "/home/c_thuilliez/Desktop/Work/script/Shiny/shiny_UI.R",
    local = TRUE
  )
  source(
    "/home/c_thuilliez/Desktop/Work/script/Shiny/shiny_server.R",
    local = TRUE
  )
