...
##----------------------------------------------------------------------------##
observeEvent(input[["heatmap_IC_gene_export"]], {
  req(values$data)
  ...
  save_image(plot, save_file_path, width = input$heatmap_IC_gene_export_width, height = input$heatmap_IC_gene_export_height, scale = input$heatmap_IC_gene_export_scale)
