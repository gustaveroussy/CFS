...
##----------------------------------------------------------------------------##
observeEvent(input[["IC_interactions_export"]], {
  req(values$data)
  ...
  plot = current_plot_graph_interactions()
  
  ## save plot
  
  save_image(plot, save_file_path, width = input$IC_interactions_export_width, height = input$IC_interactions_export_height, scale = input$IC_interactions_export_scale)
